...
\textbf{PhD} & \multicolumn{1}{r}{\textsc{King's College London}}                  \\
...
\textit{Jul 2018 --- Oct 2018} & \\ \multicolumn{2}{p{11.5cm}}{\small{\raggedright Developed a machine learning training, testing, and development library for the UK gas desk (written in Python). Built and distributed a research analytics dashboard using Flask and Docker.}}                  
\end{tabularx}
\vspace{0.1cm}
...
\textit{Jul 2019 --- Sep 2019} & \\ \multicolumn{2}{p{11.5cm}}{\small{\raggedright Produced Fisher error forecasts for feature-type non-Gaussianity in the Cosmic Microwave Background. Code written in C with MPI support.}}                  
\end{tabularx}
\vspace{0.5cm}
